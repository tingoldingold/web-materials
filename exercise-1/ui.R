                     ...
                     sidebarLayout(
                       ...
                       mainPanel(
                         ...
                         tags$div(class = "summary", checked = NA,
                                  tags$p("This map shows the electoral college 
                                         votes by states. The darker the color, 
                                         the higher the number of votes. 
                                         California has the highest votes.")
                         ),
                         tags$a(href = "https://www.archives.gov/federal-
